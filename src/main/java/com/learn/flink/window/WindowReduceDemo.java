...
/**
 1. 窗口分配器
 WindowedStream<WaterSensor, String, TimeWindow> sensorWS = sensorKS.window(TumblingProcessingTimeWindows.of(Time.hours(10)));
...
public class WindowReduceDemo {
    public static void main(String[] args) throws Exception {
        ...
        SingleOutputStreamOperator<WaterSensor> sensorDS = env.socketTextStream("localhost", 7777)
                ...
                .window(TumblingProcessingTimeWindows.of(Time.hours(10)))
                .reduce(
